...
across 202 coastal-mainland units. These units represent 10 and 28 countries,
respectively, and the observed coefficient difference is 0.631. Network
concentration therefore preserves much more of the corridor-concentration
ordering among island and archipelagic units, whereas the two rankings are
almost unrelated among coastal-mainland units. Landlocked units form a
separate geographic category.
...
additional coastal-mainland DNS units that are absent from the projection-
score and Top-1 comparisons. Across these allocation-specific cohorts, the
island coefficient exceeds the coastal-mainland coefficient by 0.461--0.715.
The repeated ordering shows that the geographic contrast persists whether
ambiguous mass is spread equally, weighted by projection score, or assigned
to the Top-1 candidate. Across the available allocation-specific cohorts, the monotonic increase is
consistent with higher-scoring candidates carrying more of the cross-layer
signal.
...
intervals are [-0.203, 0.760] for the island coefficient, [-0.284, 0.238] for
the coastal-mainland coefficient, and [-0.213, 0.902] for their 0.461
...
separately test whether the observed ordering depends on ambiguous candidate-
mass assignment.
...
The 80\% Top-2 threshold identifies four service-facing cross-layer outcomes.
Among 275 service-facing units, 81 (29.5\%) are
