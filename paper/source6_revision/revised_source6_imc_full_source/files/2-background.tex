...
regions retain coastal structure between these two resolutions.
...
broader target population and serve only as topology references. They are not
a matched control, and differences between families do not identify a service-
deployment or target-selection effect.
