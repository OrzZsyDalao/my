...
def write_readme(path: Path, run_id: str) -> None:
    ...
    sections = [
        ...
        "## 3.1 Candidate-row deduplication\nCross-layer aggregation canonicalizes atomic segment IDs and removes repeated rows using canonical segment, cable, and unordered exact landing pair. Download-file duplication therefore cannot multiply observation mass.",
